...
public class AXIMemIface512RTL_BRAM_Ext_Ctrl extends HDLModule{
...
//	public int data[];
	...
	public AXIMemIface512RTL_BRAM_Ext_Ctrl(String... args){
		super("axi_memiface_512_bram_ext_ctrl", "clk", "reset");
		...
		HDLPort din1  = HDLUtils.genInputPort(this, "data_din_external", 512, EnumSet.of(HDLPort.OPTION.EXPORT));
		HDLPort dout1 = HDLUtils.genOutputPort(this, "data_dout_external", 512, EnumSet.of(HDLPort.OPTION.EXPORT));
		...
		HDLSignal wdata = newSignal("data_din_act", HDLPrimitiveType.genSignedType(512), HDLSignal.ResourceKind.WIRE);
		HDLSignal rdata = newSignal("data_dout_act", HDLPrimitiveType.genSignedType(512), HDLSignal.ResourceKind.WIRE);
		...
		axi = new AxiMasterPort(this, "axi", 512, 512*1024*1024);
		
		HDLModule ram = new BlockRAM(512, 10, 1024);
	...
	private void genWriteSeq(HDLSequencer seq){
		...
		HDLModule fifo = new SimpleFifo512();
		...
		HDLSignal fifo_din = newSignal("fifo_din", HDLPrimitiveType.genVectorType(512));
		HDLSignal fifo_dout = newSignal("fifo_dout", HDLPrimitiveType.genVectorType(512));
...
//		fifo_re_flag.setAssign(s3, axi.writer.wready.getSignal());
	...
	public static void main(String... args){
		AXIMemIface512RTL_BRAM_Ext_Ctrl m = new AXIMemIface512RTL_BRAM_Ext_Ctrl();
